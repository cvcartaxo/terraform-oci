...
tenancy_ocid  = "ocid1.tenancy.oc1..xxxxx" = pegar informação no painel da OCI.
user_ocid     = "ocid1.user.oc1..xxxxx" = pegar informação no painel da OCI.
fingerprint   = "aa:bb:cc:dd:..." = pegar informação no painel da OCI. 
private_key_path = "~/.oci/oci_api_key.pem" 

compartment_ocid    = "ocid1.compartment.oc1..xxxxx" = pegar informação no painel da OCI.
subnet_ocid         = "ocid1.subnet.oc1.xxxxx" pegar informação no painel da OCI.
...
```
#### Aplicar o plano de execução, provisionando os recursos na nuvem.
#### É obrigatório o uso do arquivo de variáveis 'terraform.tfvars' neste comando.
```bash
terraform apply -var-file=terraform.tfvars
```
#### Exiber os valores de recursos criados com output.
```bash
terraform output
```
#### Destruir todos os recursos gerenciados pelo estado atual do Terraform.
```bash
